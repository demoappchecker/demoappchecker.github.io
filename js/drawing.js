function resizeCanvasAndResults(dimensions, canvas, results) {
  ...
  canvas.height = height
	...
	//canvas.width = document.getElementById("inputVideo").width//.videoWidth;
	//canvas.height =  document.getElementById("inputVideo").height//.videoHeight;
	
	//console.log("Height "+document.getElementById("inputVideo").videoHeight)
